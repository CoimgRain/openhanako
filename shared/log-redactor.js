/**
 * Shared diagnostic log redaction (ESM wrapper).
 *
 * Keep this file in sync with ./log-redactor.cjs so browser-side ESM code can
 * import the helpers in Vite dev/build without executing CommonJS globals.
 */
