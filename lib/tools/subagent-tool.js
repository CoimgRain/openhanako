...
export function createSubagentTool(deps) {
  ...
  return {
    ...
    execute: async (_toolCallId, params, _signal, _onUpdate, ctx) => {
      ...
      const requesterIdentity = resolveAgentIdentity(deps.listAgents, deps.currentAgentId, deps.currentAgentId);
            ...
            onSessionReady: (sp) => {
              ...
              deps.emitEvent?.({
                ...
                patch: {
                  ...
                  requestedAgentId: requestedIdentity?.executorAgentId || null,
                  requestedAgentNameSnapshot: requestedIdentity?.executorAgentNameSnapshot || null,
                  requesterAgentId: requesterIdentity?.executorAgentId || deps.currentAgentId || null,
                  requesterAgentNameSnapshot: requesterIdentity?.executorAgentNameSnapshot || null,
                  parentAgentId: requesterIdentity?.executorAgentId || deps.currentAgentId || null,
                  parentAgentNameSnapshot: requesterIdentity?.executorAgentNameSnapshot || null,
                  taskTitle,
                  taskSummary,
                  parentSessionPath,
                },
              ...
              void deps.persistSubagentSessionMeta?.(sp, {
                ...executorIdentity,
                requesterAgentId: requesterIdentity?.executorAgentId || deps.currentAgentId || null,
                requesterAgentNameSnapshot: requesterIdentity?.executorAgentNameSnapshot || null,
                parentAgentId: requesterIdentity?.executorAgentId || deps.currentAgentId || null,
